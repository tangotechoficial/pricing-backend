...
class Competitividade(models.Model):
    ...
    NUMANO = models.IntegerField()
    NUMANOMES = models.IntegerField()
    NUMSMNANO = models.IntegerField()
    NOMMES = models.IntegerField()
    DATREF = models.IntegerField()
...
#     DATREFPOD = models.IntegerField(blank=True, null=True)
#     NOMMES = models.IntegerField(blank=True, null=True) 
#     NOMSMS = models.IntegerField(blank=True, null=True) 
#     NOMDIASMN = models.IntegerField(blank=True, null=True) 
#     NOMSMSANO = models.IntegerField(blank=True, null=True) 
