...
class PlanoCompras(models.Model):
    ...
    MRGBRTOCD = models.FloatField(null=True)
    # VLRRCTLIQCAL = models.DecimalField(decimal_places=2, max_digits=10, null=True)
    VLRCSTCMPMER = models.FloatField(null=True)
    VLRCSTCMPIDL = models.FloatField(null=True)
    VLRCMVOCD = models.FloatField(null=True)
    VLRCMVOCD = models.FloatField(null=True)
    VLRCMVCAL = models.FloatField(null=True)
    # VLRVLDCAL = models.FloatField(decimal_places=2, max_digits=10, null=True)
    VLRFLXPLN = models.FloatField(null=True)
    VLRFLXSUG = models.FloatField(null=True)
    VLRICMOCD = models.FloatField(null=True)
    VLRICMCAL = models.FloatField(null=True)
    VLRIMPTOTOCD = models.FloatField(null=True)
    VLRIMPTOTCAL = models.FloatField(null=True)
    VLRMRGBRTOCD = models.FloatField(null=True)
    VLRMRGBRTCAL = models.FloatField(null=True)
    VLRPCOBSECAL = models.FloatField(null=True)
    VLRPCOBSEOCD = models.FloatField(null=True)
    VLRMCDOCD = models.FloatField(null=True)
    VLRMCDCAL = models.FloatField(null=True)
    VLRDVLCAL = models.FloatField(null=True)
    VLRPISOCD = models.FloatField(null=True)
    VLRPISCAL = models.FloatField(null=True)
    VLRPCOMEDMCD = models.FloatField(null=True)
    VLRVNDLIQOCD = models.FloatField(null=True)
    VLRVNDLIQCAL = models.FloatField(null=True)
    VLRVNDPRVCTR = models.FloatField(null=True)
    VLRPCOVNDLIQOCD = models.FloatField(null=True)
    VLRPCOVNDLIQCAL = models.FloatField(null=True)
    VLRVBAOCD = models.FloatField(null=True)
    VLRRBTCAL = models.FloatField(null=True)
    VLRRBTOCD = models.FloatField(null=True)
    VLRCMVPCOATU = models.FloatField(null=True)   
    VLRRCTLIQOCD = models.FloatField(null=True) 
    VLRDVLOCD = models.FloatField(null=True) 
