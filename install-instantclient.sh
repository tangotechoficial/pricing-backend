#!/usr/bin/env bash
ls ./oracle_instantclient
unzip ./oracle_instantclient/instantclient-basic-linux.x64-19.6.0.0.0dbru.zip -d /opt/oracle
unzip ./oracle_instantclient/instantclient-sdk-linux.x64-19.6.0.0.0dbru.zip -d /opt/oracle
unzip ./oracle_instantclient/instantclient-sqlplus-linux.x64-19.6.0.0.0dbru.zip -d /opt/oracle
ls -l /opt/oracle
