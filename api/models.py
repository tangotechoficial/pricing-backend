...
class Otimizador(models.Model):
    ...
    VLRCSTMERVND = models.DecimalField(decimal_places=2, max_digits=10)
    CODESTUNI = models.CharField(max_length=2)
    VLRMRGBRTCAL = models.DecimalField(decimal_places=2, max_digits=10)
    VLRMRGBRTOCD = models.DecimalField(decimal_places=2, max_digits=10)
    VLRMRGBRTRLZ = models.DecimalField(decimal_places=2, max_digits=10)
    VLRRCTLIQAPUCAL = models.DecimalField(decimal_places=2, max_digits=10)
    VLRRCTLIQAPUOCD = models.DecimalField(decimal_places=2, max_digits=10)
    VLRRCTLIQAPURLZ = models.DecimalField(decimal_places=2, max_digits=10)
    VLRCMVCAL = models.DecimalField(decimal_places=2, max_digits=10)
    VLRMCDCAL = models.DecimalField(decimal_places=2, max_digits=10)
    VLRMCDOCD = models.DecimalField(decimal_places=2, max_digits=10)
    VLRPCOBSECAL = models.DecimalField(decimal_places=2, max_digits=10)
    VLRPCOBSEOCD = models.DecimalField(decimal_places=2, max_digits=10)
    VLRPCOBSEMER = models.DecimalField(decimal_places=2, max_digits=10)
    VLRVNDLIQOCD = models.DecimalField(decimal_places=2, max_digits=10)
    VLRVNDLIQCAL = models.DecimalField(decimal_places=2, max_digits=10)
    VLRVNDLIQRLZ = models.DecimalField(decimal_places=2, max_digits=10)
